...
\node[cirr, node distance=5cm] (1) {$12:a^{1},b^{1},c^{1}$};

\node[cirr, below of=1, node distance=5cm] (2) {$3456:d^{1}, e^{1}, f^{1}, j^{1}$};

\node[cirr, below of=2, node distance=3cm] (3) {$7:h^{2}$};

\node[cirr, below of=2, node distance=3cm] (4) {$8:k^{2}$};
...
\node (111) [bd,   inner sep=4mm,fit = (1) (2)] {};
\end{tikzpicture}
